    ...
    <el-card v-loading="pager.loading" class="mt-4 !border-none" shadow="never">
      <div class="mt-4">
        <el-table :data="pager.lists" size="large">
          ...
          <el-table-column label="商户" prop="merchantName" min-width="100" />
...
<script lang="ts" setup name="merchantBill">
import {merchantBillLists } from "@/api/biz/agent";
