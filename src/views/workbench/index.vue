            ...
            <el-card class="!border-none mb-4 md:mr-4" shadow="never">
                ...
                <div>
                    <div class="flex leading-9">
                        ...
                        <span> {{ workbenchData.merchant.appId }}</span>
                    </div>
                    <div class="flex leading-9">
                        <div class="w-20 flex-none">API KEY</div>
                        <span> {{ workbenchData.merchant.apiKey }}</span>
                    </div>
                  <div class="flex leading-9">
                    <div class="w-20 flex-none">接口文档</div>
                    <span> <a
                        :href="workbenchData.website.apiDoc"
                        target="_blank"
...
const getData = async () => {
    ...
    workbenchData.merchant = res.merchant
    workbenchData.website = res.website
